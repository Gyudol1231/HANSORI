...
function Pungmul() {
  ...
  return (
    <div style={{ display: "flex" }}>
      <div className="div-pungmul-contents">
        <div
        ...
        <div className="div-pungmul-buttons">
          <button
            className="button-pungmul-random"
            onClick={() => window.location.reload()}
          >
            <GiInvertedDice5 className="button-pungmul-dice" />
          </button>
          <button
            className={
              checkedButton === 0
                ? "button-pungmul button-pungmul-checked"
                : "button-pungmul"
            }
            onClick={() => {
              setSound(0);
