      ...
      <div className="div-profile-contents">
        <div className="div-profile">
          {this.state.loginState ? (
            <div className="div-profile-login">
              <GoogleLogout
            ...
            >
              ...
              <div className="div-profile-buttons div-profile-buttons-01">
                <div
                  style={{
                    paddingRight: "1vw",
                  }}
            ...
            >
              ...
              <div style={{ display: "flex", justifyContent: "center" }}>
                <div className="div-profile-signup">
                  <input
                    type={this.state.visible}
                    className="input-profile-signup"
              ...
              <div className="div-profile-buttons div-profile-buttons-02">
                <button
                  className="button-profile-login"
                  onClick={() => {
